...
import {
  registrarPagamentoInadimplencia,
  Inadimplente,
} from "@/lib/actions/inadimplencia";
...
export default function InadimplenciaClient({
  ...
  const totalEmAberto = inadimplencias.reduce(
    (total, item) => total + Number(item.valorEmAberto),
    0
  );
              ...
              {inadimplencias.map((item) => (
                <tr key={item.itemId}>
                  ...
                  <td className="text-center">
                    <span
                      className={`badge ${item.statusPagamento === "pago_parcial"
                          ? "badge-warning"
                          : "badge-danger"
                        }`}
                    >
                      {item.statusPagamento === "pago_parcial"
                        ? "Parcial"
                        : "Pendente"}
                    </span>
                  </td>
        ...
        >
          ...
          >
            ...
            <p className="text-text-secondary mb-4">
              ...
              Em aberto:{" "}
              <span className="text-red-400 font-semibold">
                {formatCurrency(payModal.valorEmAberto)}
              </span>
            </p>
